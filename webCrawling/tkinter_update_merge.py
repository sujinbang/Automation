...
label_frame = ttk.LabelFrame(mainWindow, text="업데이트 문서")
label_frame.pack(padx=10, pady=10, fill="x", expand=True)

# 버튼
button6 = ttk.Button(label_frame, text="한국", command=createNewWindow6)
button6.pack(padx=7, pady=7)

button7 = ttk.Button(label_frame, text="해외", command=createNewWindow7)
